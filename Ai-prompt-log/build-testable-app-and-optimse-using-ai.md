...
#### User Request:
> "Trying to run app on iOS with `npm run ios` is failing. Run the app on iOS and fix the issue."
...
#### User Request:
> "Create a debug build for Android and iOS simulator. Zip the .app file and put the builds in the apps directory."
...
#### User Request:
> "Update the setup document with instructions on how to build the debug build and rename the file to Development."
